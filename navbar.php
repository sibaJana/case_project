...
<nav class="navbar navbar-expand-custom navbar-mainbg">
        <a class="navbar-brand navbar-logo" href="index.php">Text Case</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="csv_to_json.php"><i class="far fa-file-alt"></i>File Convertion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="password.php"><i class="fa fa-lock" aria-hidden="true"></i>password Genenator</a>
                </li>
                <li class="nav-item">
